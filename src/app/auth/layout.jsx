...
export default function AuthLayout({ children }) {
  return (
    <>
      <div className="relative bg-gradient-to-bl from-slate-100/50 via-slate-100/20 to-background">
      <Spotlight
          ...
          <div className="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
            <div>
              ...
              <div className="mt-4 md:mb-12 max-w-2xl">
                <h1 className="mb-4 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
                  The Doorway to Greatness (Literally)
                </h1>
                <p className="text-xl dark:text-slate-100/70 text-slate-950/70">
                  Students or institutions? Pick your side like it's a Marvel
                  movie, and let’s get you authenticated faster than your
            ...
            <div className="lg:px-8 md:mt-0 mt-20">
              <div className="mx-auto flex w-full flex-col justify-start items-start space-y-6 sm:w-full relative">
                {children}
                <div className="z-10 block h-[360px] w-[360px] overflow-hidden filter blur-3xl border-blue-700 rounded-[40%_60%_60%_40%/55%_67%_33%_45%] transition-all duration-500 bg-gradient-to-tr from-indigo-900 to-cyan-500 absolute left-2 -top-16"></div>
                <div className="z-10 block h-[360px] w-[360px] overflow-hidden filter blur-3xl border-blue-700 rounded-[40%_60%_60%_40%/55%_67%_33%_45%] transition-all duration-500 bg-gradient-to-tr from-indigo-900 to-cyan-500 absolute right-2 bottom-2"></div>
