...
export function parseLogoImage(file) {
  ...
  if (!file || !(file instanceof Blob)) {
    return Promise.reject(new Error("Invalid file - expected Blob or File"));
  }
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onerror = (e) => {
      ...
      reject(new Error(`Failed to load image (${file.type}, ${file.size} bytes)`));
    };
    ...
    try {
      ...
      reject(new Error(`Failed to create object URL: ${e.message}`));
    }
  });
}
